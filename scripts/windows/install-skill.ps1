...
[Environment]::SetEnvironmentVariable("AMPERO_TONE_AGENT_ROOT", $projectRoot, "User")
Write-Output "Installed ampero-tone skill to $destination"
Write-Output "Set user environment variable AMPERO_TONE_AGENT_ROOT=$projectRoot"
